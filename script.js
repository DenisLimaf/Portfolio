const modalData = {
    projetos: {
        ...
        icon: '💻',
        link: 'projetos.html',
        content: 'Tenho experiência na criação de Web Apps utilizando HTML5, CSS3 e JavaScript. Foco no desenvolvimento de layouts limpos, responsividade para dispositivos móveis, e estruturas semânticas que auxiliam em SEO.'
    },
    habilidades: {
        tag: 'Habilidades',
        title: 'Tecnologias',
        ...
        content: 'Domínio das tecnologias fundamentais da web. Especialidade em CSS avançado (Flexbox, Grid, Animações e Transições) e JavaScript ES6+. Em constante aprendizado de novas ferramentas para otimizar fluxos de trabalho.'
    },
    contato: {
        tag: 'Contato',
        title: 'Conecte-se',
        icon: '✉️',
        link: 'contato.html',
        content: 'Estou disponível para novas oportunidades de projetos freelancer, parcerias e vagas juniores. Entre em contato para trabalharmos juntos na sua próxima ideia e torná-la realidade.'
    }
};
...
function startTechEffect() {
    ...
    const techList = ['HTML5', 'CSS3', 'JAVASCRIPT', 'REACT', 'GIT', 'GITHUB', 'UI_UX', 'NODE_JS', 'REST_API', 'SQL', 'TYPESCRIPT', 'PENTEST', 'EXPLOIT', 'OSINT', 'MALWARE', 'ZERO-DAY'];
    const particles = [];
    const sparks = [];
    const hackingLogs = [
    ...
    let hackPhase = 'floating'; // phases: 'floating', 'loading', 'warning'
    ...
    function loop() {
        ...
        if (hackPhase === 'floating') {
            ...
            const progressRatio = Math.min(elapsed / 8000, 1);
            
            ctx.fillStyle = '#00ff00';
            ctx.font = '28px Courier New, monospace';
            ctx.textAlign = 'center';
            ctx.fillText('SYSTEM BEING HACKED...', canvas.width / 2, canvas.height / 2 - 50);
            ...
            ctx.fillStyle = Math.floor(Date.now() / 250) % 2 === 0 ? '#ff0000' : '#000000';
            ctx.fillRect(0, 0, canvas.width, canvas.height);
